...
function [mat3,score_block,wlt_block,block_Z,block_R,block_B,block_X]=ttest2_block_invert(mat2,num,compare,method)
score_block=cell(size(mat2,1),1);
tmp=setdiff(1:size(mat2{1,1},1),compare);
for i=1:size(mat2,1)
score_block{i,1}=ttest2_block(mat2{i,1},mat2{i,2},num,compare,method);
end
