load('matlab3.mat');
name={'Random';'Dissimilarity';'Margin';'QBC';'BORDA';'MC1';'MC2';'MC3';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';'Di,En';'Di,MB';'Di,MB(Bucklin)';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';'Di,En';'Di,MB(Markov)';'Di,MB(Markov)';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';'Di,MB(Bucklin)';'Di,MB(Markov)';'Di,MB(Markov)';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';};
