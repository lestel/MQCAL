load('matlab4.mat');
name={'Random';'Dissimilarity';'Entropy';'MarginRBF';'MarginBays';'Di,En';'Di,Ma';'Di,Ma';'Di,En,Ma';'Di,En,Un';'Di,Ma,Un';'Di,En,Ma,Un';'Di,En';'Di,Ma';'Di,Un';'Di,En,Ma';'Di,En,Un';'Di,Ma,Un';'Di,En,Ma,Un';'Di,En';'Di,Ma';'Di,Un';'Di,En,Ma';'Di,En,Un';'Di,Ma,Un';'Di,En,Ma,Un';'Di,En';'Di,Ma';'Di,Un';'Di,En,Ma';'Di,En,Un';'Di,Ma,Un';'Di,En,Ma,Un';};
...
title('\fontsize{10}Borda based MQCAL(F1)')
%set(gca,'xtick',[]);
...
title('\fontsize{10}Borda based MQCAL(Acc)')
%set(gca,'xtick',[]);
set(gca,'xticklabel',0:3:30);
ylabel('Accuracy');
xlabel('The percent of labeling');
