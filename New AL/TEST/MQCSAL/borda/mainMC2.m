load('matlab4.mat');
name={'Random';'Dissimilarity';'Entropy';'Marginrbf';'MarginBays';'Di,En';'Di,MB(Borda)';'Di,MB(Borda)';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';'Di,En';'Di,MB';'Di,MB(Bucklin)';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';'Di,En';'Di,MB(Markov)';'Di,MB(Markov)';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';'Di,MB(Bucklin)';'Di,MB(Markov)';'Di,MB(Markov)';'Di,En,MB';'Di,En,Un';'Di,MB,Un';'Di,En,MB,Un';};
...
title('\fontsize{10}Markov Chain based MQCAL(F1)')
%set(gca,'xtick',[]);
...
title('\fontsize{10}Markov Chain based MQCAL(Acc)')
%set(gca,'xtick',[]);
set(gca,'xticklabel',0:3:30);
ylabel('Accuracy');
xlabel('The percent of labeling');
